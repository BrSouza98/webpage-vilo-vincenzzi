    ...
    <b-container fluid class="bv-example-row">
      <b-row>
        <b-col
          ...
          <p>
            A prática da escola Vilo Vincenzzi com os pequenos é de respeito à
            infância e ao cuidado físico, emocional e cognitivo. Eles são
            incentivados, diariamente, a participar de desafios e descobertas e
            a conhecer a si mesmos, ao outro e ao mundo. Para promover o
            desenvolvimento e a aprendizagem da criança, o trabalho da apostila
            Aprende Brasil da Editora Positivo tem quatro eixos permeados pela
            afetividade e brincadeiras:
          </p></b-col
        >
        <b-col
          ><div
    ...
    <b-container fluid class="bv-example-row">
      <b-row>
        <b-col>
          ...
          <ul>
            <li>
              Apostilas divididas em unidades com páginas de abertura, que
              possibilitam projetos pedagógicos.
            </li>
            <li>
              Atividades por sequências didáticas que estimulam a exploração por
              parte dos alunos.
            </li>
          </ul>
          <p>
            <b>Matemática:</b> retomada e ampliação da contagem, reconhecimento
            de números, quantidades e geometria.
          </p>
          <p>
            <b>Linguagem e Letramento:</b> contatos com os signos escritos.
            Relato oral de experiências, recontagem de fatos e histórias,
            produção de textos coletivos.
          </p>
          <p>
            <b>Descobertas:</b> conceitos básicos de Ciências, História e
            Geografia. Estudo de hábitos de higiene, corpo, plantas, animais,
            ambiente, entre outros.
          </p>
          <p>
            <b>Movimento:</b> desenvolvimento da coordenação motora fina e ampla
            e esquema corporal.
          </p>
          <p>
            <b>Artes:</b> desenvolvimento da expressão, equilíbrio, autoestima,
        ...
        <b-col>
          ...
          <ul>
            <li>
              ...
              desagravos e a agir com progressiva autonomia
            </li>
            <li>
              Interessar-se progressivamente pelo cuidado com o próprio corpo,
              executando ações simples relacionadas à saúde e à higiene.
            </li>
            <li>
            ...
            <li>
              ...
              necessária, compreendendo a sua função social.
            </li>
            <li>Tentar ler e escrever segundo suas hipóteses.</li>
            <li>
              econhecer, compreender e utilizar os diferentes símbolos
              convencionalmente como forma de representação em textos lidos e
              ouvidos.
            </li>
            <li>Utilizar-se da linguagem matematicamente.</li>
            <li>
              Construir o significado dos números naturais em situações de
              contagem, medida e códigos numéricos, nos diferentes contextos:
              social, matemáticos e outros.
            </li>
            <li>
              Perceber, a partir de acontecimentos , a noção de tempo, tendo
              como referência a sua rotina diária.
            </li>
            <li>
              Reconhecer, na paisagem local e no lugar em que se encontram
              inseridos, as diferentes manifestações da natureza presentes em
              outras paisagens.
            </li>
            <li>
              Comparar seres vivos, estabelecendo diferenças e semelhanças,
              quanto à alimentação, à respiração, ao crescimento e à reprodução.
            </li>
          </ul></b-col
        >
      ...
      <b-row>
        <b-col>
          ...
          <p>
            ...
            infância, o que fornece apoio indispensável às atividades realizadas
            em aula. Elas trazem ícones que identificam os eixos cognitivos
            relacionados a cada campo de experiência envolvidos em cada matéria,
            e trabalham conteúdos de forma gradativa, apresentando e retomando
            conceitos e habilidades numa linha de aprendizado dinâmica que se
            torna interessante e desafiadora para o aluno.
          </p></b-col
        >
