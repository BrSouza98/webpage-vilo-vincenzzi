...
<b-container fluid class="bv-example-row">
  <b-row>
    ...
    <b-col><h2>Instalação de ensino</h2>
...
<div class="textocentro margemupdown"><h2><b>Fotos da nossa escola</b></h2></div>
    ...
    <div class="card-header1 corpadrao1">
      ...
      >
        <b-card-text>
          <a
            class="corpreta"
            href="http://localhost:3000/_nuxt/assets/foto12.jpg"
            target="_blank"
            >Playground</a
          >
        </b-card-text>
    ...
    <div class="card-header1 corpadrao1">
      ...
      >
        <b-card-text>
          <a
            class="corpreta"
            href="http://localhost:3000/_nuxt/assets/foto13.jpg"
            target="_blank"
            >Playground</a
          >
        </b-card-text>
      ...
      >
        <b-card-text>
          <a
            class="corpreta"
            href="http://localhost:3000/_nuxt/assets/foto14.jpg"
            target="_blank"
            >Playground</a
          >
        </b-card-text>
      ...
      >
        <b-card-text>
          <a
            class="corpreta"
            href="http://localhost:3000/_nuxt/assets/foto17.jpg"
            target="_blank"
            >Playground</a
          >
        </b-card-text>
      ...
      >
        <b-card-text>
          <a
            class="corpreta"
            href="http://localhost:3000/_nuxt/assets/foto16.jpg"
            target="_blank"
            >Playground</a
          >
        </b-card-text>
